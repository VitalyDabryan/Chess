public class ChessBoard {
    ...
    public boolean moveToPosition(int startLine, int startColumn, int endLine, int endColumn) {
        if (startLine == 0 && startColumn == 0) {board[0][0].check = false;}
        else if (startLine == 0 && startColumn == 4) {board[0][4].check = false;}
        else if (startLine == 0 && startColumn == 7) {board[0][7].check = false;}
        if (startLine == 7 && startColumn == 0) {board[7][0].check = false;}
        else if (startLine == 7 && startColumn == 4) {board[7][4].check = false;}
        else if (startLine == 7 && startColumn == 7) {board[7][7].check = false;}
        if (checkPos(startLine) && checkPos(startColumn)) {
            ...
            if (board[startLine][startColumn].canMoveToPosition(this, startLine, startColumn, endLine, endColumn)) {
                ...
                if (canMoveToPosition(startLine, startColumn, endLine, endColumn) == false) {
                ...
                return true;} else {
                    ...
                    board[startLine][startColumn] = null; return true;
                }
            } else return false;
        } else return false;
    }
    ...
    public boolean canMoveToPosition (int startLine, int startColumn, int endLine, int endColumn) {
        if (nowPlayer.equals("White")) {
            if (board[endLine][endColumn] != null && board[endLine][endColumn].getColor().equals("Black")) {
                return true;
            } else
            if (board[endLine][endColumn] != null && board[endLine][endColumn].getColor().equals("White")) {
                return true;
            }
            else return false;
        } else return false;
